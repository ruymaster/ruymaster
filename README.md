...
I have been developed several big projects as a blockchain fullstack engineer. I have been successfully worked in <b>blockchain development including L1, L2, and sidechain, defi protocols such as compound, uniswap, multichain bridges and so on, nft projects, and crypto exchanges</b>.

## Main Skills 
[Cryptography](https://cryptobook.nakov.com/), [Solidity](http://solidityproject.com/),  [Node.js](https://nodejs.org/), [Circom/snarkjs](https://docs.circom.io/), [Golang](https://go.dev/), [Rust](https://www.rust-lang.org/), [Ruby](https://www.ruby-lang.org/), [C/C++/C#](https://www.cplusplus.com/),  [Javascript](https://www.javascript.com/),  [TypeScript](https://www.typescriptlang.org/), [React.js](https://reactjs.org/), [Python](https://www.python.org/).
